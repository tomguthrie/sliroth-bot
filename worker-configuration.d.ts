/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 857e04b0dc8a68754a59156086e953ee)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_BOT_TOKEN" | "DISCORD_PUBLIC_KEY" | "PUBLIC_BASE_URL">> {}
}
declare module "*.sql" {
	const value: string;
