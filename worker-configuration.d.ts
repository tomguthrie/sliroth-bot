/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8ccfa0d7df03423ac6b83b72ead141fd)
// Runtime types generated with workerd@1.20260801.1 2026-08-06 nodejs_compat
interface __BaseEnv_Env {
	DISCORD_BOT_TOKEN: string;
	DISCORD_CHANNEL_ID: string;
	DISCORD_YT_ROLE_ID: string;
	PUBLIC_BASE_URL: string;
	YOUTUBE_CHANNEL_ID: string;
	YOUTUBE_CALLBACK_TOKEN: string;
	YOUTUBE_WEBSUB_SECRET: string;
	YOUTUBE_SUBSCRIPTIONS: DurableObjectNamespace<import("./src/index").YouTubeSubscription>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "YouTubeSubscription";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_BOT_TOKEN" | "DISCORD_CHANNEL_ID" | "DISCORD_YT_ROLE_ID" | "PUBLIC_BASE_URL" | "YOUTUBE_CHANNEL_ID" | "YOUTUBE_CALLBACK_TOKEN" | "YOUTUBE_WEBSUB_SECRET">> {}
}
