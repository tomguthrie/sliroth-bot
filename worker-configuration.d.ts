/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d69d2306150fe9b106ec21049536d1a0)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_BOT_TOKEN" | "PUBLIC_BASE_URL">> {}
}
declare module "*.sql" {
	const value: string;
