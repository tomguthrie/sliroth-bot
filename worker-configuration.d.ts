/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1fd630200a358283753faa086ab0be5f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_BOT_TOKEN" | "DISCORD_PUBLIC_KEY" | "PUBLIC_BASE_URL" | "TWITCH_CLIENT_ID" | "TWITCH_CLIENT_SECRET" | "TWITCH_EVENTSUB_SECRET" | "TWITCH_ANALYTICS_CHANNEL_ID">> {}
}
declare module "*.sql" {
	const value: string;
