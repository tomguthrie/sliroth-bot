/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7bdcf419d3e482b3e01ecc1773f577f2)
// Runtime types generated with workerd@1.20260801.1 2026-08-06 nodejs_compat
interface __BaseEnv_Env {
	TOKEN_STORE: KVNamespace;
	TWITCH_SUBSCRIPTIONS_INDEX: KVNamespace;
	YOUTUBE_SUBSCRIPTIONS_INDEX: KVNamespace;
	TWITCH_ANALYTICS_DB: D1Database;
	DISCORD_MESSAGES: Queue;
	SUBSCRIPTION_EVENTS: Queue;
	...
	TWITCH_ANALYTICS_CHANNEL_ID: string;
	TWITCH_ANALYTICS_SETUP_SECRET: string;
	YOUTUBE_SUBSCRIPTIONS: DurableObjectNamespace<import("./src/index").YouTubeSubscription>;
	TWITCH_SUBSCRIPTIONS: DurableObjectNamespace<import("./src/index").TwitchSubscription>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "YouTubeSubscription" | "TwitchSubscription";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_BOT_TOKEN" | "DISCORD_PUBLIC_KEY" | "PUBLIC_BASE_URL" | "TWITCH_CLIENT_ID" | "TWITCH_CLIENT_SECRET" | "TWITCH_EVENTSUB_SECRET" | "TWITCH_ANALYTICS_CHANNEL_ID" | "TWITCH_ANALYTICS_SETUP_SECRET">> {}
}
declare module "*.sql" {
	const value: string;
